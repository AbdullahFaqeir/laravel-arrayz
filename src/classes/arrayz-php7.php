...
class Arrayz
{
    ...
    */
    ...
    public function lteq($a, $b)
    {
        return $a <= $b;
    }

    public function gteq($a, $b)
    {
        return $a >= $b;
    }

    public function eq3($a, $b)
    {
        return $a === $b;
    }

    public function neq3($a, $b)
    {
        return $a !== $b;
    }
    ...
    public function resolve_join()
    {
        ...
        array_walk($this->source, function (&$value, &$key) use (&$join_array, &$op, &$join_by, &$joiner_1, &$joiner_2, &$join_keys, &$join_type) {
            if (isset($value[$join_by[0]])) { //Are you there?
                ...
                } elseif ($join_type == 'left') { //Be with me even not you
